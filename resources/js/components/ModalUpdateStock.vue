  ...
  methods: {
    ...
    async updateProduct() {
      ...
      try {
        ...
        product_id: this.productToEdit.id, // ID produk yang diupdate
        transaction_type: 'penambahan', // Jenis transaksi
        quantity: this.newStock, // Jumlah stok yang ditambahkan
        date: currentDate, // Tanggal hari ini
        user_id: userId // ID user dari localStorage
        };
